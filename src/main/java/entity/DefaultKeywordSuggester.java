...
public class DefaultKeywordSuggester {
    ...
    static {
        ...
        MAP.put("Building websites and applications", "web development, software engineering, frontend, backend");
        MAP.put("Starting projects or businesses", "entrepreneurship, product, leadership, management");
    }

    public static String suggest(List<String> orderedInterests) {
