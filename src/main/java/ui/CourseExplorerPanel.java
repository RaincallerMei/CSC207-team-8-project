...
public class CourseExplorerPanel extends JPanel implements PropertyChangeListener {
    ...
    private final RecommendCoursesViewModel recommendViewModel;
    ...
    public CourseExplorerPanel(RecommendCoursesController recommendController,
        ...
        splitPane.setResizeWeight(0.35); // 左边 35%
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (RecommendCoursesViewModel.PROPERTY_RECOMMENDATIONS.equals(name)) {
        ...
        if (RecommendCoursesViewModel.PROPERTY_ERROR.equals(name)) {
        ...
        if (whyViewModel != null &&
                WhyCoursesViewModel.PROPERTY_REASON.equals(name)) {
        ...
        if (whyViewModel != null &&
                WhyCoursesViewModel.PROPERTY_ERROR.equals(name)) {
            JOptionPane.showMessageDialog(
                    this,
                    evt.getNewValue(),
                    "Why this course – Error",
                    JOptionPane.ERROR_MESSAGE
            );
        }
    }
    ...
    private void updateResultsView(List<Course> courses) {
        ...
        if (courses == null || courses.isEmpty()) {
            ...
            for (Course c : courses) {
                CourseResultPanel itemPanel = new CourseResultPanel(c, whyController);
    ...
    private void handleSubmit() {
        ...
        if (interests.isEmpty()) {
            JOptionPane.showMessageDialog(
                    this,
                    "Please enter some interests first!",
                    "Missing Input",
